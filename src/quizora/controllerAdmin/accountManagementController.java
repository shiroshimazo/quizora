...
public class accountManagementController {
 ...
 private final AdminProfileDAO dao;
 public accountManagementController(){this(new AdminProfileDAO());}
 protected accountManagementController(AdminProfileDAO dao){this.dao=dao;}
 protected String profileRole(){return "admin";}
 ...
 private String error(Throwable e){if(e instanceof SecurityException)return accessMessage();if(e instanceof IllegalArgumentException)return e.getMessage();if(e instanceof java.sql.SQLException sql){if(sql.getErrorCode()==1062)return "That username or email is already in use.";if("40001".equals(sql.getSQLState()))return "Profile changed. Close this form, refresh and try again.";}if(e instanceof java.io.IOException)return "Unable to read the picture. Choose a valid PNG or JPEG image.";return "Unable to complete the request. Check the database connection and try again.";}
}
