    ...
    public static void main(String[] args) throws Exception {
        ...
        Platform.startup(() -> {
            ...
            try {
                Quizora.satoshi(14);
                UserSession.clear();
                FXMLLoader loader = new FXMLLoader(Quizora.class.getResource("/Resources/fxml/teacher/overview.fxml"));
                ...
                controller.render(new TeacherDashboardData(0,0,0,0,0,null,today,List.of(),emptyDays,
                ...
                controller.render(new TeacherDashboardData(245,24,36,8,273,76.4,today,
                ...
                ImageIO.write(SwingFXUtils.fromFXImage(root.snapshot(null,new WritableImage(1720,2000)),null),
                        "png",new File("build/teacher-dashboard-preview.png"));
