            ...
            try {
                ...
                for (int i = 0; i < views.length; i++) {
                    ...
                    for (var node : buttons) {
                        ...
                        expectsDashboard |= i == 1 && ("dashboardButton".equals(button.getId()) || "createQuizButton".equals(button.getId()) || "assignedSubjectsButton".equals(button.getId()) || "studentResultsButton".equals(button.getId()) || "quizStatisticsButton".equals(button.getId()) || "profileButton".equals(button.getId()));
